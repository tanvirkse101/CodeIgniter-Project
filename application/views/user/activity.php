<div class="container border p-2">
	...
	<div class="p-2">
		<div class="row">
			<h2 id="registered">Registered User Data:</h2><a class="btn btn-primary" style="margin-left: 55%;" href="#unregistered" role="button">Go to unregistered</a>
	...
	<div class="p-2">
		<div class="row">
			<h2 id="unregistered">Unregistered User Data:</h2> <a style="margin-left: 55%;" class="btn btn-primary" href="#registered" role="button">Go to registered</a>
